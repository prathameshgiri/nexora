...
export default function Dashboard() {
  ...
  return <div className="min-h-screen bg-[#f7faf8] text-[#18352f]">
    <aside className={`fixed inset-y-0 left-0 z-30 flex w-[220px] flex-col border-r border-[#e4eeea] bg-white px-5 py-6 transition-transform lg:translate-x-0 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`}>
