...
const pageMeta: Record<string, { title: string; eyebrow: string; description: string; icon: typeof Wallet; action: string }> = {
  ...
  "financial-health": { title: "Financial health", eyebrow: "YOUR MONEY WELLNESS", description: "A clear view of the habits shaping your financial future.", icon: ShieldCheck, action: "View recommendations" },
...
const nav = [
  ["Overview", "/", LayoutDashboard], ["Transactions", "/transactions", ArrowDownRight], ["Budget planner", "/budget-planner", PieChart], ["Goals", "/goals", Target], ["AI Coach", "/ai-coach", Sparkles], ["Salary slips", "/salary-slips", FileText], ["Investments", "/investments", TrendingUp], ["Financial health", "/financial-health", ShieldCheck], ["Settings", "/settings", Settings],
] as const;
