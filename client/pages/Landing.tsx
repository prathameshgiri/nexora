...
import { ArrowRight, BarChart3, CheckCircle2, ChevronRight, CircleDollarSign, LayoutDashboard, Lock, PieChart, ShieldCheck, Sparkles, Star, Target, TrendingUp, Wallet, Zap, XCircle, Fingerprint, ChevronDown, Smartphone } from "lucide-react";
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fcfb] text-[#18352f] selection:bg-[#1f9b78] selection:text-white">
      {/* 1. Navbar */}
      <header
        className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${
          scrolled ? "bg-white/80 backdrop-blur-lg shadow-[0_4px_30px_rgba(24,53,47,0.04)] py-4" : "bg-transparent py-6"
        }`}
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            {!loading && user ? (
              <Link to="/dashboard" className="flex items-center gap-2 rounded-xl bg-[#1f7a63] px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-emerald-900/10 transition hover:-translate-y-0.5 hover:bg-[#196b56]">
                <LayoutDashboard size={18} /> Go to Dashboard
              </Link>
            ) : (
              <>
                <Link to="/login" className="hidden text-sm font-bold text-[#4a635d] hover:text-[#1f9b78] sm:block">Log in</Link>
                <Link to="/login?mode=signup" className="rounded-xl bg-[#1f7a63] px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-emerald-900/10 transition hover:-translate-y-0.5 hover:bg-[#196b56]">Sign up free</Link>
              </>
            )}
          </div>
        </div>
      ...
      <main>
        ...
        <section className="relative overflow-hidden pt-36 pb-20 lg:pt-48 lg:pb-32">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#d2efe4] bg-[#f0f9f5] px-4 py-1.5 mb-8">
              <Sparkles size={14} className="text-[#1f9b78]" />
              <span className="text-xs font-bold text-[#2a6d59]">Nexora AI 2.0 is now live</span>
            </div>
            <h1 className="mx-auto max-w-4xl text-5xl font-extrabold tracking-tight text-[#112a25] sm:text-7xl">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link to="/login?mode=signup" className="group flex h-14 items-center gap-2 rounded-xl bg-[#1f7a63] px-8 text-base font-bold text-white shadow-xl shadow-emerald-900/15 transition-all hover:-translate-y-1 hover:bg-[#16604d]">
                Get Started Now <ArrowRight size={18} className="transition group-hover:translate-x-1" />
              </Link>
        ...
        <section className="bg-[#f8fcfb] py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center mb-16">
              <h2 className="text-3xl font-extrabold tracking-tight text-[#112a25] sm:text-4xl">Why switch to Nexora?</h2>
              <p className="mt-4 text-lg text-[#69887f]">Stop wrestling with messy spreadsheets and complex formulas.</p>
            </div>
            <div className="grid gap-8 lg:grid-cols-2 max-w-5xl mx-auto">
              <div className="rounded-3xl border border-[#fbd5ce] bg-white p-8 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#fdf0ed] text-[#e6755c]"><XCircle size={20} /></div>
              ...
              <div className="rounded-3xl border-2 border-[#1f9b78] bg-[#f0f9f5] p-8 shadow-lg shadow-emerald-900/10">
                <div className="flex items-center gap-3 mb-6">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#1f9b78] text-white"><CheckCircle2 size={20} /></div>
        ...
        <section id="how-it-works" className="py-24 bg-[#112a25] text-white">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
        ...
        <section className="bg-white py-24 border-b border-[#eff5f2]">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
             <h2 className="text-3xl font-extrabold tracking-tight text-[#112a25] sm:text-4xl mb-4">Works with your banks</h2>
             <p className="text-lg text-[#69887f] mb-12">Export from any major Indian bank and let our AI do the rest.</p>
             <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
                {["HDFC Bank", "ICICI Bank", "SBI", "Axis Bank", "Kotak", "Yes Bank", "Paytm", "Google Pay"].map(bank => (
                  <div key={bank} className="rounded-xl border border-[#eff5f2] bg-[#f8fcfb] px-6 py-3 text-sm font-bold text-[#4a635d] shadow-sm hover:border-[#1f9b78] hover:text-[#1f9b78] transition">
                    {bank}
                  </div>
                ))}
             </div>
        ...
        <section className="py-20 bg-[#1f9b78]">
        ...
        <section className="bg-[#112a25] py-24 text-white overflow-hidden relative">
           ...
           <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl mb-6">Your data is strictly confidential.</h2>
                <p className="text-[#a0c2b7] text-lg leading-relaxed mb-8">We use AES-256 bank-level encryption. We don't sell your data to third parties. We don't have access to your bank credentials.</p>
                <div className="space-y-4">
                   {["256-bit encryption", "Biometric authentication ready", "No third-party data sharing"].map(s => (
                     <div key={s} className="flex items-center gap-3">
                        <ShieldCheck size={20} className="text-[#1f9b78]" />
        ...
        {/* 11. Testimonials */}
        <section id="testimonials" className="py-24 bg-[#f8fcfb]">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="text-center text-3xl font-extrabold tracking-tight text-[#112a25] sm:text-4xl mb-16">Loved by thousands</h2>
                ...
                <ul className="space-y-4 mb-8">
                  {["Track basic expenses & income", "Monthly budget limits", "Basic analytics", "1 user account"].map(f => (
                    <li key={f} className="flex items-center gap-3 text-sm font-semibold text-[#4a635d]">
                      <CheckCircle2 size={18} className="text-[#1f9b78]" /> {f}
                    </li>
                  ))}
                </ul>
        ...
        {/* 13. FAQ Section */}
        <section className="bg-[#f8fcfb] py-24 border-t border-[#eff5f2]">
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            <h2 className="text-3xl font-extrabold tracking-tight text-[#112a25] sm:text-4xl text-center mb-12">Frequently Asked Questions</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="rounded-2xl border border-[#eff5f2] bg-white p-6 shadow-sm transition hover:shadow-md group">
                  <h3 className="text-lg font-extrabold text-[#112a25] flex justify-between items-center">
                    {faq.q} <ChevronDown size={18} className="text-[#83a298] transition group-hover:text-[#1f9b78]" />
                  </h3>
        ...
        <section className="bg-white py-24">
           <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
              <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-[#f0f9f5] text-[#1f9b78] mb-6">
                <Smartphone size={32} />
              </div>
              <h2 className="text-3xl font-extrabold tracking-tight text-[#112a25] sm:text-4xl mb-6">Take your finances anywhere</h2>
              <p className="mx-auto max-w-2xl text-lg text-[#69887f] mb-10">Nexora is perfectly optimized for all screen sizes. Add expenses on the go with our lightning-fast mobile web interface.</p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                 <div className="rounded-xl border border-[#eff5f2] px-6 py-4 font-bold text-[#112a25] flex items-center gap-3 cursor-pointer hover:border-[#1f9b78] transition">
                   <span className="text-2xl">🍎</span> Add to iOS Home Screen
                 </div>
                 <div className="rounded-xl border border-[#eff5f2] px-6 py-4 font-bold text-[#112a25] flex items-center gap-3 cursor-pointer hover:border-[#1f9b78] transition">
                   <span className="text-2xl">🤖</span> Install Android PWA
                 </div>
              </div>
           </div>
        </section>
        ...
        <section className="py-24 bg-white">
          <div className="mx-auto max-w-5xl px-6 lg:px-8">
            <div className="rounded-[2.5rem] bg-gradient-to-br from-[#112a25] to-[#1f4a3d] p-12 text-center shadow-2xl md:p-20 relative overflow-hidden">
              ...
              <h2 className="relative z-10 mx-auto max-w-2xl text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
                Ready to transform your financial life?
              </h2>
              <p className="relative z-10 mx-auto mt-6 max-w-xl text-lg text-[#a7c5bc]">
                Join thousands of users who have taken control of their money with Nexora. Sign up in seconds.
              </p>
              <div className="relative z-10 mt-10">
                <Link to="/login?mode=signup" className="inline-flex h-14 items-center gap-2 rounded-xl bg-[#1f9b78] px-8 text-base font-bold text-white transition hover:-translate-y-1 hover:bg-[#1bb387]">
      ...
      {/* Footer */}
      <footer className="bg-[#f8fcfb] py-12 border-t border-[#eff5f2]">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 lg:flex-row lg:px-8">
          <Logo />
          <p className="text-sm font-semibold text-[#83a298]">© {new Date().getFullYear()} Nexora Technologies. All rights reserved.</p>
          <div className="flex gap-6">
            <Link to="#" className="text-sm font-bold text-[#4a635d] hover:text-[#1f9b78]">Privacy Policy</Link>
            <Link to="#" className="text-sm font-bold text-[#4a635d] hover:text-[#1f9b78]">Terms of Service</Link>
          </div>
        </div>
      </footer>
    </div>
