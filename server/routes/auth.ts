...
const safeUser = (u: User) => ({ id: u.id, email: u.email, fullName: u.fullName, mobile: u.mobile, role: u.role, status: u.status, salaryAmount: u.salaryAmount, salaryDate: u.salaryDate });
